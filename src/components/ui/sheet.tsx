  ...
  ({ side = "right", className, children, ...props }, ref) => (
    <SheetPortal>
      ...
      <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
        {children}
        <SheetPrimitive.Close className="absolute end-4 top-4 grid h-9 w-9 place-items-center rounded-xl text-ink-soft hover:bg-muted hover:text-foreground transition-colors focus:outline-none focus:ring-4 focus:ring-navy/15 disabled:pointer-events-none">
          <X className="h-4 w-4" />
