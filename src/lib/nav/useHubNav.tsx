...
import {
  ...
  CreditCard, ShieldCheck, Compass, Zap as Lightning, Newspaper as Article, CircleDollarSign,
} from "lucide-react";
...
export function useHubNav() {
  ...
  const financeSub = [
    ...
    leaf("fi.billing", t("nav.billing"), "/billing", CircleDollarSign, "payments.billing"),
  ];
  const staffSub = [
